...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col-reverse items-center justify-center p-4 md:p-8 w-full max-w-screen">
      {/* MoodTracker ligger alltid underst */}
      <div className="w-full max-w-4xl">
        <MoodTracker />
      </div>

      {/* InfoCard ligger alltid överst */}
      <div className="w-full max-w-4xl">
        <InfoCard
          title="Om sidan"
